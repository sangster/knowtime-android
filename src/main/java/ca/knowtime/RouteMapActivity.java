                    ...
                    try {
                        ...
                        for( int j = 0; j < pathArray.length(); j++ ) {
                            ...
                            for( int i = 0; i < routePoints.length(); i++ ) {
                                ...
                                if( latPoint < latPointMin || latPointMin == 0 ) {
                                    latPointMin = latPoint;
                                }
                                if( latPoint > latPointMax || latPointMax == 0 ) {
                                    latPointMax = latPoint;
                                }
                                if( lngPoint < lngPointMin || lngPointMin == 0 ) {
                                    lngPointMin = lngPoint;
                                }
                                if( lngPoint > lngPointMax || lngPointMax == 0 ) {
                                    lngPointMax = lngPoint;
                                }
                        ...
                        runOnUiThread( new Runnable()
                        {
                            ...
                            public void run() {
                                mMap.moveCamera( CameraUpdateFactory.newLatLngBounds(
                                        new LatLngBounds( new LatLng( latPointMinFinal, lngPointMinFinal ),
                        ...
                        for( int i = 0; i < routes.length(); i++ ) {
                            ...
                            if( busLocationJSON == null || lat != 0 || lng != 0 ) {
                                ...
                                runOnUiThread( new Runnable()
                                {
                                    @Override
                                    public void run() {
                                        markers[markerCounter] = mMap.addMarker(
